...
export const useUpdateWork = () => {
  ...
  const updateWork = async (workId, workData, status = "draft") => {
    setIsLoading(true);
    setError(null);
    ...
    try {
      ...
      let errorMessage = "Erro ao atualizar trabalho. Tente novamente.";
  ...
  const saveDraft = (workId, workData) => updateWork(workId, workData, "draft");
  const submitForReview = (workId, workData) => updateWork(workId, workData, "under_review");
